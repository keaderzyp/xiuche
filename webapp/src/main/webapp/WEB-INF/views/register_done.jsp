...
<html>
	...
	<body>
		...
		<a href="rest/userAdd/mainIndex"> 
			...
			<div class="collapse-btn">
				...
				<div class="content ">
					意外产生的损失（互助期间内，因意外事故或自然灾害造成会员车辆直接损失。如由于：碰撞损坏、车身划伤、发动机被水淹、玻璃破碎等导致的损失）
				</div>
			</div>
			<div class="collapse-btn">
				<div class="title">
				...
				<div class="content collapse">
					以实际维修价互助(会员单次损失的修理费用以及救援费用合计不超过事故发生时该车的市场价值)
				</div>
			</div>
			<div class="collapse-btn">
				<div class="title">
	...
	<script type="text/javascript">
		for(var i=0;i<document.getElementsByClassName("collapse-btn").length;i++){
			document.getElementsByClassName("collapse-btn")[i].onclick=function(){
