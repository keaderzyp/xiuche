...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="rest/user/adminLogin" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="username" id="username" size="25" value="michael" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" />
			</div>
		</div>
		<div class="form-group">
