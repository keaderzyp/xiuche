...
public class FileUpload {
	...
	@Value("${tomcat.images.path}")
	private String tomcatImagesPath;

	/**
	 * 文件上传 Controller方法参数例子：@RequestParam("uploadFile") MultipartFile file
	...
	public String getTomcatImagesPath() {
		return tomcatImagesPath;
	}

	public void setTomcatImagesPath(String tomcatImagesPath) {
		this.tomcatImagesPath = tomcatImagesPath;
	}
