...
public class BasicPage {
	...
	public String toString() {
		return "BasicPage [pageNo=" + pageNo + ", pageSize=" + pageSize + ", pageTotalSize=" + pageTotalSize
				+ ", pageGroup=" + pageGroup + ", pageGroupSize=" + pageGroupSize + ", pageTotalGroup=" + pageTotalGroup
