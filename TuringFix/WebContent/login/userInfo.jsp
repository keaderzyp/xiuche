...
<script type="text/javascript" charset="utf-8">
	$(function() {
		$('#user_userInfo_tree').tree({
			url : '${pageContext.request.contextPath}/sysRes/allTreeNode.do',
			parentField : 'pid',
			lines : true,
			checkbox : true,
...
<div class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center',title:'个人信息'" style="overflow: hidden;padding: 5px;" align="center">
		<form id="user_userInfo_form" method="post">
			<input name="userId" type="hidden" value="${sessionInfo.userId}" />
			<table class="tableForm">
				...
				<tr>
					<th>修改密码</th>
					<td><input name="userPass" type="password" class="easyui-validatebox" data-options="required:'true',missingMessage:'请填写登录密码'" /></td>
				</tr>
				<tr>
					<th>确认密码</th>
					<td><input name="testNum"  type="password" class="easyui-validatebox" data-options="required:true,validType:'eqPwd[\'#user_userInfo_form input[name=userPass]\']'"   />
					</td>
				</tr>
				<tr>
					<th>所属角色</th>
