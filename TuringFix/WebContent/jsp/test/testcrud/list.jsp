...
<html>
                        ...
                        <div class="panel-body">
                            <div class="table-min table-responsive ">
                                <table class="table  table-actions table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach items="${data.rows }" var="map" varStatus="i">
                                        <tr>
                                           <td>${i.count }</td>
                                           <td>
                                           		<input  class="icheckbox" type="checkbox" />
	...
	function turnPage(p){
		location.href="<%=request.getContextPath()%>/testUser/queryPage.do?page="+p+"&rows="+$("#rows").val();
	}
	function turnRows(){
		location.href="<%=request.getContextPath()%>/testUser/queryPage.do?page=1&rows="+$("#rows").val();
	}
	</script>
</html>
